            ...
            <div className={styles.cardContainer}>
                <div className={styles.businessCard} id="front">
                    ...
                    <div className={styles.contactInfo}>
                        ...
                        <a href={employee.website} target="_blank" rel="noopener noreferrer" className={styles.link}>
                            {employee.website}
                        </a>
                    </div>
                ...
                <div className={styles.vcardDownload}>
                    ...
                    >
                        <Image src="/download-icon.svg" alt="Download Icon" className={styles.downloadIcon} width={18}
                               height={18}/>
                        Download
                    </a>
                </div>
